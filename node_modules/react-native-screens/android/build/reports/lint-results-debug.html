...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      ...
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Wed Mar 15 19:16:02 AEDT 2023 by AGP (7.3.1)</nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#GradleDependency"><i class="material-icons warning-icon">warning</i>Obsolete Gradle Dependency (6)</a>
      ...
      <a class="mdl-navigation__link" href="#KtxExtensionAvailable"><i class="material-icons warning-icon">warning</i>KTX Extension Available (1)</a>
    </nav>
  </div>
...
<tr>
<td class="countColumn">1</td><td class="issueColumn"><i class="material-icons warning-icon">warning</i>
<a href="#KtxExtensionAvailable">KtxExtensionAvailable</a>: KTX Extension Available</td></tr>
<tr><td></td><td class="categoryColumn"><a href="#ExtraIssues">Included Additional Checks (19)</a>
</td></tr>
<tr><td></td><td class="categoryColumn"><a href="#MissingIssues">Disabled Checks (36)</a>
</td></tr>
</table>
<br/>              </div>
...
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:10</span>: <span class="message">A newer version of com.android.tools.build:gradle than 4.2.2 is available: 7.4.2</span><br /><pre class="errorlines">
...
<span class="lineno">  11 </span>      classpath <span class="string">"org.jetbrains.kotlin:kotlin-gradle-plugin:${safeExtGet('kotlinVersion', '1.6.21')}"</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:107</span>: <span class="message">A newer version of androidx.appcompat:appcompat than 1.1.0 is available: 1.6.1</span><br /><pre class="errorlines">
<span class="lineno"> 104 </span>
<span class="lineno"> 105 </span>dependencies {
<span class="lineno"> 106 </span>    implementation <span class="string">'com.facebook.react:react-native:+'</span>
<span class="caretline"><span class="lineno"> 107 </span>    implementation <span class="warning"><span class="string">'androidx.appcompat:appcompat:1.1.0'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 108 </span>    implementation <span class="string">'androidx.fragment:fragment:1.2.1'</span>
<span class="lineno"> 109 </span>    implementation <span class="string">'androidx.coordinatorlayout:coordinatorlayout:1.1.0'</span>
<span class="lineno"> 110 </span>    implementation <span class="string">'androidx.swiperefreshlayout:swiperefreshlayout:1.0.0'</span></pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:108</span>: <span class="message">A newer version of androidx.fragment:fragment than 1.2.1 is available: 1.5.5</span><br /><pre class="errorlines">
<span class="lineno"> 105 </span>dependencies {
<span class="lineno"> 106 </span>    implementation <span class="string">'com.facebook.react:react-native:+'</span>
<span class="lineno"> 107 </span>    implementation <span class="string">'androidx.appcompat:appcompat:1.1.0'</span>
<span class="caretline"><span class="lineno"> 108 </span>    implementation <span class="warning"><span class="string">'androidx.fragment:fragment:1.2.1'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 109 </span>    implementation <span class="string">'androidx.coordinatorlayout:coordinatorlayout:1.1.0'</span>
<span class="lineno"> 110 </span>    implementation <span class="string">'androidx.swiperefreshlayout:swiperefreshlayout:1.0.0'</span>
<span class="lineno"> 111 </span>    implementation <span class="string">'com.google.android.material:material:1.1.0'</span></pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:109</span>: <span class="message">A newer version of androidx.coordinatorlayout:coordinatorlayout than 1.1.0 is available: 1.2.0</span><br /><pre class="errorlines">
<span class="lineno"> 106 </span>    implementation <span class="string">'com.facebook.react:react-native:+'</span>
<span class="lineno"> 107 </span>    implementation <span class="string">'androidx.appcompat:appcompat:1.1.0'</span>
<span class="lineno"> 108 </span>    implementation <span class="string">'androidx.fragment:fragment:1.2.1'</span>
<span class="caretline"><span class="lineno"> 109 </span>    implementation <span class="warning"><span class="string">'androidx.coordinatorlayout:coordinatorlayout:1.1.0'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 110 </span>    implementation <span class="string">'androidx.swiperefreshlayout:swiperefreshlayout:1.0.0'</span>
<span class="lineno"> 111 </span>    implementation <span class="string">'com.google.android.material:material:1.1.0'</span>
<span class="lineno"> 112 </span>    implementation <span class="string">"androidx.core:core-ktx:1.5.0"</span></pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:110</span>: <span class="message">A newer version of androidx.swiperefreshlayout:swiperefreshlayout than 1.0.0 is available: 1.1.0</span><br /><pre class="errorlines">
<span class="lineno"> 107 </span>    implementation <span class="string">'androidx.appcompat:appcompat:1.1.0'</span>
<span class="lineno"> 108 </span>    implementation <span class="string">'androidx.fragment:fragment:1.2.1'</span>
<span class="lineno"> 109 </span>    implementation <span class="string">'androidx.coordinatorlayout:coordinatorlayout:1.1.0'</span>
<span class="caretline"><span class="lineno"> 110 </span>    implementation <span class="warning"><span class="string">'androidx.swiperefreshlayout:swiperefreshlayout:1.0.0'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 111 </span>    implementation <span class="string">'com.google.android.material:material:1.1.0'</span>
<span class="lineno"> 112 </span>    implementation <span class="string">"androidx.core:core-ktx:1.5.0"</span>
<span class="lineno"> 113 </span>}
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:111</span>: <span class="message">A newer version of com.google.android.material:material than 1.1.0 is available: 1.8.0</span><br /><pre class="errorlines">
<span class="lineno"> 108 </span>    implementation <span class="string">'androidx.fragment:fragment:1.2.1'</span>
<span class="lineno"> 109 </span>    implementation <span class="string">'androidx.coordinatorlayout:coordinatorlayout:1.1.0'</span>
<span class="lineno"> 110 </span>    implementation <span class="string">'androidx.swiperefreshlayout:swiperefreshlayout:1.0.0'</span>
<span class="caretline"><span class="lineno"> 111 </span>    implementation <span class="warning"><span class="string">'com.google.android.material:material:1.1.0'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 112 </span>    implementation <span class="string">"androidx.core:core-ktx:1.5.0"</span>
<span class="lineno"> 113 </span>}
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:112</span>: <span class="message">A newer version of androidx.core:core-ktx than 1.5.0 is available: 1.9.0</span><br /><pre class="errorlines">
<span class="lineno"> 109 </span>    implementation <span class="string">'androidx.coordinatorlayout:coordinatorlayout:1.1.0'</span>
<span class="lineno"> 110 </span>    implementation <span class="string">'androidx.swiperefreshlayout:swiperefreshlayout:1.0.0'</span>
<span class="lineno"> 111 </span>    implementation <span class="string">'com.google.android.material:material:1.1.0'</span>
<span class="caretline"><span class="lineno"> 112 </span>    implementation <span class="warning"><span class="string">"androidx.core:core-ktx:1.5.0"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 113 </span>}
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:106</span>: <span class="message">Avoid using + in version numbers; can lead to unpredictable and unrepeatable builds (com.facebook.react:react-native:+)</span><br /><pre class="errorlines">
<span class="lineno"> 103 </span>}
<span class="lineno"> 104 </span>
<span class="lineno"> 105 </span>dependencies {
<span class="caretline"><span class="lineno"> 106 </span>    implementation <span class="warning"><span class="string">'com.facebook.react:react-native:+'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 107 </span>    implementation <span class="string">'androidx.appcompat:appcompat:1.1.0'</span>
<span class="lineno"> 108 </span>    implementation <span class="string">'androidx.fragment:fragment:1.2.1'</span>
<span class="lineno"> 109 </span>    implementation <span class="string">'androidx.coordinatorlayout:coordinatorlayout:1.1.0'</span></pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/swmansion/rnscreens/ScreenWindowTraits.kt">../../src/main/java/com/swmansion/rnscreens/ScreenWindowTraits.kt</a>:110</span>: <span class="message">Unnecessary; SDK_INT is always >= 21</span><br /><pre class="errorlines">
<span class="lineno"> 107 </span>  <span class="keyword">val</span> translucent = screenForTranslucent?.isStatusBarTranslucent ?: <span class="keyword">false</span>
<span class="lineno"> 108 </span>  UiThreadUtil.runOnUiThread(
<span class="lineno"> 109 </span>      <span class="keyword">object</span> : GuardedRunnable(context) {
<span class="caretline"><span class="lineno"> 110 </span>          <span class="warning"><span class="annotation">@TargetApi</span>(Build.VERSION_CODES.LOLLIPOP)</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 111 </span>          override <span class="keyword">fun</span> runGuarded() {
<span class="lineno"> 112 </span>              <span class="comment">// If the status bar is translucent hook into the window insets calculations</span>
<span class="lineno"> 113 </span>              <span class="comment">// and consume all the top insets so no padding will be added under the status bar.</span></pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/swmansion/rnscreens/ScreenStackFragment.kt">../../src/main/java/com/swmansion/rnscreens/ScreenStackFragment.kt</a>:160</span>: <span class="message">Prefer "<code>SHOW_AS_ACTION_IF_ROOM</code>" instead of "<code>SHOW_AS_ACTION_ALWAYS</code>"</span><br /><pre class="errorlines">
<span class="lineno"> 157 </span>                onSearchViewCreate?.invoke(newSearchView)
<span class="lineno"> 158 </span>            }
<span class="lineno"> 159 </span>            menu.add(<span class="string">""</span>).apply {
<span class="caretline"><span class="lineno"> 160 </span>                setShowAsAction(MenuItem.<span class="warning">SHOW_AS_ACTION_ALWAYS</span>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 161 </span>                actionView = searchView
...
<a name="KtxExtensionAvailable"></a>
<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp" id="KtxExtensionAvailableCard" style="display: block;">
            <div class="mdl-card mdl-cell mdl-cell--12-col">
  <div class="mdl-card__title">
    <h2 class="mdl-card__title-text">KTX Extension Available</h2>
  </div>
              <div class="mdl-card__supporting-text">
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:108</span>: <span class="message">Add suffix <code>-ktx</code> to enable the Kotlin extensions for this library</span><br /><pre class="errorlines">
<span class="lineno"> 105 </span>dependencies {
<span class="lineno"> 106 </span>    implementation <span class="string">'com.facebook.react:react-native:+'</span>
<span class="lineno"> 107 </span>    implementation <span class="string">'androidx.appcompat:appcompat:1.1.0'</span>
<span class="caretline"><span class="lineno"> 108 </span>    implementation <span class="warning"><span class="string">'androidx.fragment:fragment:1.2.1'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div class="metadata"><div class="explanation" id="explanationKtxExtensionAvailable" style="display: none;">
...
To suppress this error, use the issue id "KtxExtensionAvailable" as explained in the <a href="#SuppressInfo">Suppressing Warnings and Errors</a> section.<br/>
<br/></div>
</div>
</div>
<div class="chips">
<span class="mdl-chip">
    <span class="mdl-chip__text">KtxExtensionAvailable</span>
</span>
<span class="mdl-chip">
...
<span class="mdl-chip">
    <span class="mdl-chip__text">Priority 4/10</span>
              ...
              <div class="mdl-card__actions mdl-card--border">
<button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="explanationKtxExtensionAvailableLink" onclick="reveal('explanationKtxExtensionAvailable');">
Explain</button><button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="KtxExtensionAvailableCardLink" onclick="hideid('KtxExtensionAvailableCard');">
Dismiss</button>            </div>
            </div>
          </section>
...
Vendor: Android Open Source Project (jetified-startup-runtime-1.0.0)<br/>
Identifier: jetified-startup-runtime-1.0.0<br/>
...
Vendor: Android Open Source Project (jetified-activity-1.2.4)<br/>
Identifier: jetified-activity-1.2.4<br/>
Feedback: <a href="https://issuetracker.google.com/issues/new?component=192731">https://issuetracker.google.com/issues/new?component=192731</a><br/>
</div>
<br/>
<br/></div>
...
aspect of it either by using <code>@OptIn</code> or by being annotated with that marker<br/>
themselves, effectively causing further propagation of the opt-in aspect.<br/><div class="vendor">
Vendor: Android Open Source Project (jetified-annotation-experimental-1.1.0)<br/>
Identifier: jetified-annotation-experimental-1.1.0<br/>
Feedback: <a href="https://issuetracker.google.com/issues/new?component=192731">https://issuetracker.google.com/issues/new?component=192731</a><br/>
</div>
<br/>
<br/></div>
...
Vendor: Android Open Source Project (appcompat-1.4.1)<br/>
Identifier: appcompat-1.4.1<br/>
Feedback: <a href="https://issuetracker.google.com/issues/new?component=192731">https://issuetracker.google.com/issues/new?component=192731</a><br/>
</div>
<br/>
<br/></div>
